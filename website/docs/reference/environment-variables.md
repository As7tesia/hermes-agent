...
| `BRAVE_API_KEY` | Brave Search API key for native web search ([brave.com/search/api](https://brave.com/search/api)) |
| `BRAVE_API_BASE_URL` | Override Brave Search API base URL |
